...
\begin{center}
\Large \textbf{Practice Problem Set with Detailed Solutions}\\[4pt]
\large \textbf{Chapter 6: Economic Growth, the Financial System, and Business Cycles}\\
\textit{Hubbard, O'Brien, and Serletis (4th Canadian Edition)}
\end{center}
...
\textbf{9. Productivity and Technology – Solow Type Example}

\textbf{Question:}  
Output is given by \(Y = A K^{0.3} L^{0.7}\). Initially, \(A=1\), \(K=100\), \(L=100\).  
(a) Find initial output.  
(b) If \(A\) increases by 10\%, find new output and percentage increase.

\textbf{Solution:}

\underline{Step 1: Compute initial output}
\[
Y_0 = 1 \times 100^{0.3} \times 100^{0.7} = 1 \times 100 = 100
\]

\underline{Step 2: After 10\% increase in \(A\)}
\[
...
\textbf{Interpretation:}  
A 10\% productivity improvement raises output by exactly 10\%, holding capital and labour constant.

---

\textbf{10. Business Cycle Data Interpretation}

\textbf{Question:}  
Use the following table of real GDP growth rates to identify recession and recovery periods:

\begin{center}
\begin{tabular}{@{}lccccc@{}}
\toprule
Year & 2018 & 2019 & 2020 & 2021 & 2022 \\ \midrule
Growth Rate (\%) & 2.6 & 1.8 & -4.5 & 4.1 & 2.0 \\ \bottomrule
\end{tabular}
\end{center}

(a) Which year represents recession and which recovery?  
(b) How would unemployment and inflation behave in these years?

\textbf{Solution:}
\begin{itemize}
    \item (a) 2020 shows a recession (negative growth). 2021 marks a recovery (positive rebound).
    \item (b) During 2020: output falls, unemployment rises, and inflation falls. During 2021: economic recovery reduces unemployment and increases inflationary pressure.
\end{itemize}

---

\section*{Part C – Applied Discussion}

\textbf{11. Policies to Promote Growth}

\textbf{Question:}  
Suggest two policies that could increase long-run economic growth in Canada and explain their short-run effects on the business cycle.

\textbf{Solution:}
\begin{itemize}
    \item \textbf{Investment incentives:} Tax credits for R\&D or corporate investment raise capital formation and productivity. In the short run, such policies boost aggregate demand, reducing unemployment.
    \item \textbf{Education and training programs:} Enhance human capital, improving long-term productivity. In the short run, they stimulate spending and employment in the education sector.
\end{itemize}
...
\textbf{12. Savings and Investment Equality}

\textbf{Question:}  
Explain how the equality of savings and investment ensures efficient resource use in the economy.

\textbf{Solution:}

\underline{Step 1: National income identity}
\[
Y = C + I + G
\]
...
\underline{Step 2: Interpretation}
\begin{itemize}
    \item Savings provide the funds for investment.
    \item When savings = investment, all income not consumed is used for productive purposes.
    \item If investment falls short of savings, output is underutilized — leading to recessions.
\end{itemize}
