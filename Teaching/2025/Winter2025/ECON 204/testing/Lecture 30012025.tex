...
\usepackage{amsmath}
\usepackage{pgfplots}
\pgfplotsset{compat=1.16} % Use a lower compatibility level
\usepackage{array}

\title{Income Inequality in Canada}
\subtitle{Causes, Measurement, and Policy Responses}
\author{Economist}
\institute{Macroeconomics 101}
\date{\today}
...
% Table 1: Income Distribution for Example 1
\begin{frame}{Income Distribution Table: Example 1}
Consider the following income distribution for a hypothetical country:
\begin{table}[h]
\centering
\begin{tabular}{|c|c|}
\hline
...
This table shows the percentage of total income earned by each quintile of the population.
\end{frame}

% Table 2: Quintiles and Cumulative Shares for Example 1
\begin{frame}{Quintiles and Cumulative Shares: Example 1}
...
% Lorenz Curve Plot for Example 1
\begin{frame}{Lorenz Curve: Example 1}
\begin{tikzpicture}
\begin{axis}[
...
The Lorenz curve is plotted using the cumulative income shares from the table.
\end{frame}
...
\[
\text{Area}_{\text{Lorenz}} = \frac{1}{2} \times (5 + 15) \times 20 + \frac{1}{2} \times (15 + 30) \times 20 + \frac{1}{2} \times (30 + 50) \times 20 + \frac{1}{2} \times (50 + 100) \times 20
\]
\[
\text{Area}_{\text{Lorenz}} = 200 + 450 + 800 + 1500 = 3000
\]
\end{frame}
...
\[
\text{Area}_{\text{between}} = \text{Area}_{\text{equality}} - \text{Area}_{\text{Lorenz}} = 5000 - 3000 = 2000
\]
...
\[
\text{Gini Coefficient} = \frac{\text{Area}_{\text{between}}}{\text{Area}_{\text{equality}}} = \frac{2000}{5000} = 0.4
\]
A Gini coefficient of 0.4 indicates moderate income inequality.
\end{frame}
