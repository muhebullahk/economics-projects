...
\begin{frame}{Human Capital Investment: Income Streams}


\begin{itemize}

\item The vertical axis shows \textbf{annual earnings}.

\item The horizontal axis shows \textbf{age}.

\item The figure compares three possible \textbf{income streams}:
\begin{itemize}

\item \textbf{Income stream A:} entering the labour market early (around age 16).

\item \textbf{Income stream B:} completing high school and starting work at age 18.

\item \textbf{Income stream C:} attending college/university and entering the labour market around age 22.

\end{itemize}

\item Education changes the entire \textbf{lifetime earnings profile}.
...
\begin{frame}{Costs of Investing in Education}
\transfade

\begin{itemize}

\item Investing in education involves several types of costs.

\item \textbf{Opportunity costs} (forgone earnings):

\begin{itemize}

\item Area \textbf{a}: income forgone between ages 16 and 18 if the individual stays in school.

\item Area \textbf{b + c}: income forgone between ages 18 and 22 if the individual attends college.

\end{itemize}

\item \textbf{Direct costs of education}:

\begin{itemize}

\item Area \textbf{d} represents tuition, books, and other schooling expenses.

\end{itemize}

\item These costs occur \textbf{while the student is studying} and reduce income early in life.

\end{itemize}

\end{frame}

\begin{frame}{Benefits of Investing in Education}
\transfade

\begin{itemize}

\item Education can increase future earnings.

\item \textbf{Area b + e} represents the earnings advantage of finishing high school relative to leaving school early.

\item \textbf{Area f} represents the additional lifetime earnings from college relative to high school.



\end{itemize}

\begin{block}{Investment Decision}

Individuals should invest in education if:

\[
\text{Present Value of Benefits} > \text{Present Value of Costs}
\]
...
\item Human capital theory treats education as a \textbf{long-term investment in productivity and earnings}.
...
\[
PV = Y+ \sum_{t=1}^{T-18} \frac{Y}{(1+r)^t}
\approx Y+\frac{Y}{r}\]
...
\centering
\includegraphics[width=0.9\linewidth]{F6a}
\end{frame}


\begin{frame}{Figure 9.6: Costs, Benefits, and Financing of Training}
\centering
\includegraphics[width=0.9\linewidth]{F6b}
\end{frame}

\begin{frame}{Figure 9.6: Costs, Benefits, and Financing of Training}
\centering
\includegraphics[width=0.9\linewidth]{F6c}
\end{frame}
